...
\begin{itemize}
    \item Metodo di Newton
          \lstinputlisting[language=Matlab]{capitolo2/es5_newton.m}
    \item Metodo delle secanti
          \lstinputlisting[language=Matlab]{capitolo2/es5_secanti.m}
          \item Metodo di Steffensen
          \lstinputlisting[language=Matlab]{capitolo2/es5_steffensen.m}


          % \item Metodo di bisezione
          % \lstinputlisting[language=Matlab]{capitolo2/es5_bisezione.m}
          % \item Metodo delle corde
          % \lstinputlisting[language=Matlab]{capitolo2/es5_corde.m}
\end{itemize}
