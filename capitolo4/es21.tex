...
\begin{table}[ht]
    ...
    \resizebox{\columnwidth}{!}{
        \begin{tabular}{| l l l l l l l|}
            \hline
            \rule{0cm}{0.8cm}\shortstack{Punti                                                                                                             \\
            equidistanti} & \vline & Lagrange              & Newton                & Hermite               & spline0               & spline                \\
            \hline
    ...
    \caption{Errori di valori approssimati usando algoritmi di esercizi 16-20 con punti equidistanti}
    \label{tab:21_equidistant}
\end{table}
\FloatBarrier
\begin{figure}[!ht]
    \centering
    \includegraphics[width=16cm,height=10cm,keepaspectratio]{capitolo4/es21_figure_chebyshev.png}
    \caption{Comparazione di errori di algoritmi di esercizi 16-20 con punti di Chebyshev}
...
\begin{table}[ht]
    ...
    \resizebox{\columnwidth}{!}{
        \begin{tabular}{| l l l l l l l|}
            \hline
            \rule{0cm}{0.8cm}\shortstack{Punti                                                                                                          \\
            Chebyshev} & \vline & Lagrange              & Newton                & Hermite               & spline0               & spline                \\
            \hline
    ...
    \caption{Errori di valori approssimati usando algoritmi di esercizi 16-20 con punti di Chebyshev}
